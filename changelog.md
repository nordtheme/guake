...
Implemented the main shell script theme file [`nord.sh`](https://github.com/nordtheme/guake/blob/develop/src/sh/nord.sh). (@svengreb, #1, 152a9ac0)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/guake/blob/develop/readme.md#installation).

<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/nordtheme/guake/develop/src/assets/scrot-colortest.png" /><br />
  </picture>
